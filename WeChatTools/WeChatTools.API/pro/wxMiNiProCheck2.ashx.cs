...
namespace WeChatTools.API.pro
{
    ...
    /// 微信小程序状态检测接口 --正式使用接口
    /// </summary>
    public class WXMiNiProCheck2 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (context.Request.HttpMethod.ToUpper().Equals(GET))
            {
                ...
                if (!string.IsNullOrEmpty(context.Request["appid"]) && !string.IsNullOrEmpty(context.Request["key"]) && context.Request["key"].Length == 32)
                {
                    ...
                    if (userKey.Trim() != wxCheckApiKey)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                string json2 = "{\"Mode\":\"AuthWXMiniProKey\",\"Param\":\"{\'CheckUrl\':\'" + urlCheck + "\',\'UserKey\':\'" + userKey + "\'}\"}";
